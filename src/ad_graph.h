...
///////////////////////////////////////////////////////////////////////
// Optimum Cycle Mean functions:

// Find the min cycle mean for a SCC g.
extern
float
...
extern
float 
find_min_cycle_mean_for_components( const ad_graph< cninfo >& cg, 
                                    int plus_infinity );

inline
float 
find_max_cycle_mean_for_components( const ad_graph< cninfo >& cg,
                                    int plus_infinity )
{
    // Assuming that the edge weights are negated in the input graph.
    return -find_min_cycle_mean_for_components( cg, plus_infinity );
}
